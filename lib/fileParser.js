...
class FileParser {
  ...
  readCSV_(progressCallback, doneCallback) {
    /* this object */
    var self = this;
  ...
  readXLSX_(progressCallback, doneCallback) {
  }

  readGEXF_(progressCallback, doneCallback) {

  }

  readDOT_(progressCallback, doneCallback) {
  }
   ...
   */
  parse(progressCallback, doneCallback) {
